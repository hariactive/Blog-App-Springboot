package com.example.chaloagain.config;
...
import com.example.chaloagain.services.AccountService;
import com.example.chaloagain.services.PostService;
...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception{
        ...
        if(posts.size()==0){
            ...
            post1.setBody("This is the body");
            post1.setAccount(account1);

            Post post2 = new Post();
            post2.setTitle("title of post2");
            post2.setBody("This is the body2");
